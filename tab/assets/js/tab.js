...
(function () {
  ...
  const tabGroups = document.querySelectorAll(".ghtm-tab");

  // Loop through each tab group
  tabGroups.forEach((tabGroup) => {
    // Get the tabs nav and content for this tab group
    const tabsNav = tabGroup.querySelector(".ghtm-tab-nav");
    const tabsNavItem = tabsNav.querySelectorAll(".ghtm-tab-nav-item");
  ...
  function setActiveTab(tabGroup, tabName) {
    // Get the tabs nav and content for this tab group
    const tabsNav = tabGroup.querySelector(".ghtm-tab-nav");
    const tabsContent = tabGroup.querySelector(".ghtm-tab-content");

    // Remove the active class from all tab nav items and content panes
    tabsNav.querySelectorAll(".ghtm-tab-nav-item").forEach((tabNavItem) => {
      tabNavItem.classList.remove("active");
    });
    tabsContent
      .querySelectorAll(".ghtm-tab-content-panel")
      .forEach((tabPane) => {
